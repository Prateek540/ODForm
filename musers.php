...
$conn=new mysqli($dbservername,$dbusername,$dbpassword,$dbname);
  ...
  $query="SELECT user.username, user.id FROM user";
  ...
  if ($result->num_rows > 0)
   {
    ...
    {
        $id=$row['id'];
      echo "<tr>"."<td>".$sr."</td>"."<td>".$row['username']."</td>"."<td>"."<form method='POST' action='duser.php'><input type='hidden' name='id' value='$id'><input type='submit' value='Delete User'></form>"."</td>"."</tr>";
      $sr++;
    }
  }
  else
