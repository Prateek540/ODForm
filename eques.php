...
$conn=new mysqli($dbservername,$dbusername,$dbpassword,$dbname);
  ...
  $query="SELECT user.username, question.ques, question.qid FROM user, question WHERE question.idq=user.id";
  ...
  if ($result->num_rows > 0)
   {
    ...
    {
        $id=$row['qid'];
      echo "<tr>"."<td>".$sr."</td>"."<td>".$row["username"]."</td>"."<td>".$row["ques"]."</td>"."<td>"."<form method='POST' action='dques.php'><input type='hidden' name='id' value='$id'><input type='submit' value='Delete Question'></form>"."</td>"."</tr>";
      $sr++;
    }
  }
  else
  {
    echo "<h5>No questions yet.</h5>";
  }
}
